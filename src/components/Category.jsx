...
export default function Category({ data }) {
  return (
    <div className="md:px-10 px-2 md:py-5 pt-5">
      <div className="grid lg:grid-cols-8 md:grid-cols-4 grid-cols-4 bg-white md:p-1 p-2 shadow-md lg:p-1 rounded-lg">
        {data.map((item, index) => {
          return (
            <a href="/" key={`category-${index}`}>
              <div className="flex justify-center flex-col items-center md:m-2 m-1 border border-gray-300 hover:border-indigo-500 rounded-md">
                <img
